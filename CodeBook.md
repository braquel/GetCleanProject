...
Below are the following elements of the measurements data pertinent to the project
...
Below are list of features generated by the sensors and subsequent transformations rendered  on  measurements. For more details of the features- refer to the "features_infp.txt" contained in the zip file of the study data sets.
